  ...
  modalContent = (
    <React.Fragment>
      <p id="modalText">
        ...
        leaving the field red. <strong>European (WWII) Combat </strong>
        <br />
        ...
        (Training). <strong>78th Division Band</strong>
        ...
        Support (in 1999). <strong>Relieved and Reorganized </strong>
        <br />
