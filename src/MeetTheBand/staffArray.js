...
export const staff = [
  {
    id: 1,
    name: "CW4 Luis J. Santiago - Commander",
    bio: "Chief Warrant Officer 4 Luis J. Santiago Sierra is a native of Yauco, Puerto Rico. Chief Santiago started his military career in 1995 as a 17-year-old Private First Class with the 248th Army Band of the Puerto Rico National Guard. From 1996 to 2002, he served with the Air National Guard Bands in Texas and Massachusetts. Upon returning to Puerto Rico in 2003, he rejoined the Puerto Rico Army National Guard and shortly after was selected as a Warrant Officer Candidate. Chief Santiago completed WOCS at Ft Rucker, Alabama in 2006 and was appointed as Commander of the 248th AB. ¶ During his time with the Puerto Rico National Guard, Chief Santiago also served as Protocol Officer, TAC Officer for the Warrant Officer Course at the PRNG RTI, and Instructor for the PRNG Language Center. He also produced the Veterans Day Concert in a collaboration with the PRNG and the Government of Puerto Rico which was broadcasted on TV as well as the production of a Holiday music recording entitle 'Recuerdos y Tradicion' with the participation of various Grammy Artists.  ¶ In 2013, upon relocating to Boston, MA for a civilian job with Berklee College of Music, Chief Santiago was appointed as Commander of the 319th Army Band, US Army Reserve at Ft Totten, NY, and upon its inactivation and merger into the 78th Army Band at JBMDL, NJ was reassigned as Commander of the 78th AB.  ¶ Chief Santiago's civilian education includes a BM in Professional Music from Berklee College of Music and an MMus in Songwriting from Bath Spa University, UK. He is also a graduate of PLDC, BNCOC, WOCS, WOBC, WOAC, WOILE, TAC Officer Course, and HTAR. His awards include the Meritorious Service Medal, Army Commendation Medal, Army Achievement Medal, and the National Defense Medal.  ¶ Currently, Chief Santiago lives with his family in Massachusetts working as a Military Affairs Representative for Berklee College of Music. ",
    img: noPic,
    section: "Command Team",
  },
  {
    id: 2,
    name: "CW2 Hugh M. Stuart - Executive Officer",
  ...
  {
    id: 3,
    name: "CW2 Joseph M. Young - Executive Officer",
  ...
  },
  {
    ...
    bio: "Sergeant Kathleen Dougherty plays trombone with the 78th Army Band. She joined the unit in 2018, and is now the facilities NCO of the unit. She majored in Music Education at Indiana University of Pennsylvania and still resides in the state. In the civilian world, she teaches music to student of all grade levels.",
    img: noPic,
    section: "Brass",
  },
  {
  ...
  },
  {
    id: 34,
    name: "SGT Chad Smith",
    bio: "SGT Chad Smith, from Harrisburg, PA, joined the 78th Army Band after completing college at West Chester University majoring in Music Education.  He currently plays trumpet in the Fort Dixieland Brass Ensemble and plays French horn in the concert band, ceremonial band and drill band.",
    img: noPic,
    section: "Brass",
  },
  {
  ...
  {
    id: 15,
    name: "MSG Nicholas Greeson",
    bio: "Master Sergeant Nicholas Greeson enlisted in the US Army Reserve as a saxophone player with the 307th Army Band in June of 1996 upon graduation from high school. Since that time he has progressed through the ranks and currently serves as the Platoon Sergeant for the JB MDL Detachment of the 78th Army Band and the MPT Leader of the Fort Dixieland Brass Band. In his duties over the years he has performed extensively on flute, clarinet, saxophone, and horn as well as an enlisted conductor and drum major. He has been awarded the Army Achievement Medal and 3 times awarded the Army Commendation Medal. MSG Greeson was selected as the Senior Non Commissioned Officer of the year for the Army Band field's Reserve Component in 2020. On the civilian side, MSG Greeson has been a professional music educator since 2006. He is an adjudicator in the marching arts for Tournament of Bands and Drum Corps Associates. He has also presided as a clinician for music education conferences in NJ and DE and has been selected as a clinician for the prestigious Midwest Band and Orchestra Clinic in December 2021. MSG Greeson holds music degrees from West Chester University of Pennsylvania and the American Band College. He currently resides in Delaware with his wife Gina and son Robert.",
    img: noPic,
    section: "Woodwinds",
  },
  {
  ...
  {
    id: 19,
    name: "SGT Christine Won",
    bio: "Sergeant Christine Won was born in Seoul, South Korea, and came to the United States at the age of 14. She grew up in Queens, NY where she graduated from Francis Lewis High School in 2008. That same year, she attended Basic Combat Training at Fort Jackson, SC, and Advanced Individual Training at The Army School of Music in Little Creek, VA. Sergeant Won served in the 319th Army Band out of Fort Totten, NY for 9 years and later transitioned into the 78th Army Band out of Fort Dix, NJ. As an Army Bandsman, Sergeant Won plays the flute and piccolo and currently performs in the Latin-Salsa Jazz band “Liberty Vibes.” ¶  Sergeant Won competed in and won the Best Warrior Competition at the division level at Fort Knox, KY in 2019, and competed again at the USARC level at Fort Bragg, NC in the same year. In 2020, she became a sponsor and trained Soldiers to compete in the Best Warrior Competition at Fort Dix, NJ. In 2021, Sergeant Won also competed in the Best Warrior Competition as a squad at the division level at Fort Hunter Liggett, CA. In 2022, Sergeant Won competed in the Interallied Confederation of Reserve Officers (CIOR) Military Competition (MILCOMP) in Athens, Greece. ¶ Sergeant Won has attended various military schools: Basic Leader Course (BLC), Master Fitness Training Course (MFTC), Combat Life Savers Course (CLS), Unit Prevention Leadership Course (UPL), and Suicide Prevention Course (ACE-SI). ¶ Sergeant Won’s awards and decorations include the Army Achievement Medal (3OLC), Armed Forces Reserve Medal (AFRAM), Army Reserve Component Achievement Medal (3OLC), and 7 Certificate of Achievement (COA). ¶ Sergeant Won holds a bachelor’s degree in Mathematics from Baruch College, New York, NY, and a master’s degree in Education from Mercy College, Dobbs Ferry, NY. Sergeant Won’s short-term goals are to become promoted to Staff Sergeant and train to become a Drill Sergeant for the US Army. Her long-term goal is to participate in triathlon races and complete a sixmajor world marathon. ¶ Sergeant Won’s personal interest is distance/endurance running. She completed the TCS New York City Marathon in 2016 and 2017, the Honolulu Marathon in 2018, the Bank of America Chicago Marathon in 2019, Philadelphia Marathon in 2019, and BMW Berlin Marathon in 2021. Sergeant Won aspires to participate in distance/endurance running challenges around the world.",
    img: noPic,
    section: "Woodwinds",
  },
  {
  ...
  {
    id: 21,
    name: "SPC Keith Stoltzfus",
    bio: "Specialist Keith Stoltzfus hails from Lancaster County, Pennsylvania and joined the Army Reserve in 2008. He is a graduate of Lebanon Valley College with a Bachelor’s of Science degree in Music Education and a Bachelor’s of Arts degree in Applied Music with an emphasis on Vocal Studies. He also holds a Master’s of Education degree from LaSalle University focusing on 21’st Century Learners. SPC Stoltzfus spent 3 years teaching music in Anne Arundel County Public Schools, MD before moving back to the great state of Pennsylvania where he currently is a music teacher at Central Dauphin East High School in Harrisburg, PA. ¶ In addition to teaching full time, SPC Stoltzfus is an active performer, private lesson teacher, and guest clinician in the Central Pennsylvania area. He also serves as a Council member, Church musician, and Handbell Choir Director at Christ Lutheran Church in York, PA. ¶ In his past time, SPC Stoltzfus enjoys spending time outdoors, watching football, and living the great life with his wife, Amy, and two daughters, Liesl and Clara. SPC Keith Stoltzfus hails from Lancaster County, Pennsylvania and joined the Army Reserve in 2008. He is a graduate of Lebanon Valley College with a Bachelor’s of Science degree in Music Education and a Bachelor’s of Arts degree in Applied Music with an emphasis on Vocal Studies. He also holds a Master’s of Education degree from LaSalle University focusing on 21’st Century Learners. SPC Stoltzfus spent 3 years teaching music in Anne Arundel County Public Schools, MD before moving back to the great state of Pennsylvania where he currently is a music teacher at Central Dauphin East High School in Harrisburg, PA. ¶ In addition to teaching full time, SPC Stoltzfus is an active performer, private lesson teacher, and guest clinician in the Central Pennsylvania area. He also serves as a Council member, Church musician, and Handbell Choir Director at Christ Lutheran Church in York, PA. ¶ In his past time, SPC Stoltzfus enjoys spending time outdoors, watching football, and living the great life with his wife, Amy, and two daughters, Liesl and Clara. ",
    img: noPic,
    section: "Woodwinds",
  },
/* 
  ...
  }, */
  {
    id: 23,
    name: "SFC Ed Kennedy",
    bio: "Sergeant First Class Edward J. Kennedy, from Cumberland County, NJ, enlisted in the Army Reserve in March of 1990 when, as a high school senior, he learned that becoming a member of the military band was an enlistment option for qualified candidates. As a skilled percussionist, he joined the 307th Army Band in Willow Grove, PA. He performed in front of thousands of audiences, including German civilians during a 3-week tour in Germany, and gained rank by completing the required training. In 2008, when the 307th was disbanded, the existing members were merged into multiple units to form the 78th Army Band under the command of the 99th Division. He has worked as the unit's Additional Duty Safety Officer, Squad Leader, and most recently as the Human Resource Officer. ¶ He has completed various courses such as PLDC, HRRT, BNCOC, and SLC. These courses have been incredibly meaningful and resulted not only in vital knowledge but also lifelong friendships. He has also received many awards, including the Army Service Ribbon, the National Defense Ribbon, the Army Achievement Medal, the Army Reserve Overseas Training Ribbon, the Army NCO Professional Development Ribbon, the Armed Forces Reserve Medal, and the Army Commendation Medal. ¶ After receiving his Bachelor's Degree in Criminal Justice, Kennedy worked for many years as a Private Detective, mostly investigating suspected insurance fraud. In 2007, he started his career as an Account Representative with IMX, a QTC Company. He met his wife, Colleen, in 1998, and they have three daughters, Catherine, Caroline, and Aine. They currently live in Cumberland County, New Jersey in Hopewell Township and value their family time immensely.",
    img: noPic,
    section: "Percussion",
  },
  ...
  {
    id: 5,
    name: "SPC Tainna Chagas",
    bio: `Percussionist, instructor and songwriter Specialist Chagas brings a rich wealth of percussive experience gained in her native Brazil and internationally. SPC Chagas moved to New York, USA in 2016, and quickly started to get involved with several different music scenes including Latin jazz, pop and soul music. She has collaborated with important names as Nina Lee, Jerry Barnes, Katreese Barnes, Arturo O’Farrill and the Latin Jazz Orchestra, Orkestra Rumpilezz, Bobby Sanabria, Atiyed, DJ Throttle. In the classical scene, SPC  Chagas has collaborated with Jean Yves Thibaudet, Martha Argerich, Maxim Vengerov, Midori Goto, Ricardo Castro and Colin Currie. ¶ SPC Chagas has taken part in several recording projects, such Nabiyah Be, Ponte, casa e Flor by Saulo Fernandes, Bailinho de quinta, Sertanilia (recorded first album) and the Youth Orchestra of Bahia. In the popular field,SPC Chagas has played with leading international artists from the Brazilian Popular Music (MPB) scene, such as Moraes Moreira, Saulo Fernandes, Ivete Sangalo, Luis Caldas, Claudia Leitte (halftime NBA for Orlando Magic) and Carlinhos Brown, amongst others. ¶ Since studying Percussion at the Federal University of Bahia in Brazil, SPC Chagas has diversified her percussive research and experience through different fields and styles, taking part in festivals, masterclasses and concerts across Brazil and abroad. In addition to touring the United States and Brazil,SPC Chagas has performed in the UK, Spain, Switzerland, Italy and France, including a special concert for Angela Merkel, Chancellor of Germany. ¶ At the Youth Orchestra of Bahia, the main Orchestra of NEOJIBA Project in Salvador, SPC Chagas had her intensive experience with the symphonic repertoire, from March 2013 to October 2016, where she participate of very importante concerts and performances, such as:  ¶ 2013: YOBA's DVD recording, at the Castro Alves Theatre, in Salvador, Bahia; NEOJIBA's 5th anniversary at the Castro Alves Theatre; plus another 8 symphonic concerts in Salvador. 2014: two international tours, such as the first US Tour with 12 concerts in 4 states (Arizona, Missouri, Indiana, California, with an audience of 9.125 people), alongside pianist Jean Yves Thibaudet; and the European Tour through 7 cities in Switzerland, Italy and England (with an audience of 12.681 people), alongside Martha Argerich, Colin Currie and other prestigious soloists; plus another 10 symphonic concerts, including a special one for Angela Merkel, Chancellor of Germany.  ¶ 2015: 13 symphonic concerts, two of them with the participation of world well known musicians Maxim Vengerov and Midori, both violin players. ¶ 2016: European Tour in some of the main concert halls in Europe - Switzerland, Italy and France (with an audience of 12.240 people), under the regency of its artistic director, Ricardo Castro, and in company of two of today's greatest musicians: the pianist Martha Argerich and the violinist Midori Goto; plus another 19 symphonic concerts, including an special project with Le Sacre du Printemps, from Igor Stravinsky, with a ballet, and a special concert with Ivete Sangalo, the most famous brazilian singer from actuality. She took part at other important orchestras in Salvador, like Bahia Symphonic Orchestra (temp), Rumpilezz Orchestra, Soteropolifônica Orchestra and Obirin Orchestra. ¶ As of August 13, 2021, SPC Chagas has been proudly serving her country in the United States Army Reserves as a member of the 78th Army Band. She currently plays percussion in the 78th’s concert band, marching band,  latin band, brass quintet, and dixieland band. SPC Chagas also took part in the film 'Musica' in 2022, which stars and is directed by Rudy Mancuso for Amazon Studios and Wonderland Sound and Vision.`,
    img: noPic,
    section: "Percussion",
  },
  {
    id: 25,
    name: "SPC Timothy Murphy",
    bio: "Specialist Timothy Murphy grew up in Lancaster Pennsylvania where he began drumming in fourth grade. After gaining an appreciation for the marching arts in high school he became a music education major at West Chester University for a year. Later in the years that came, he moved forward as a professional musician within the army reserve joining the military in September 2020 as one of the unit’s newest members. ¶ During his time as a high school student, Murphy played numerous roles in his school’s Fine and Performing Arts programs. ¶ A few were the marching band playing marching quads/tenors, as well as the concert band covering non-pitched percussion and timpani. While attending West Chester University Murphy played for the Incomparable Golden Rams marching band, the steel band ensemble, and the Latin jazz ensemble. Outside of school, Murphy played quads for the Skyliners drum corps as the center quad in 2018, Fusion Core quads in 2020 (both groups Drum Corps Associates), played vibraphone for Gate City Percussion in 2020 (Winter guard international), and played quads with Gold drum and bugle corps in 2021(Drum Corps International). Murphy’s favorite group to perform with is the next one! ¶ Murphy plans on going back to school to continue pursuing music education and one day become a band director, as well as continue in DCA and WGI to gain as much knowledge and experience as he can. Murphy spends his free time watching tv, playing video games, exercising, and practicing for the next audition! ",
    img: noPic,
    section: "Percussion",
  },
  {
