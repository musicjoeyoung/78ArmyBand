...
export const staff = [
  ...
  {
    id: uuidv4(),
    name: "SPC Michael Feliciano-Vidot",
  ...
  {
    id: uuidv4(),
    name: "CDT Augustus Fadden",
    bio: "Cadet Fadden grew up in Frankford, DE and graduated from Indian River High School in 2021. He joined the 78th Army Band immediately after high school as a Specialist Fadden.His initial entry training consisted of Basic Training at Fort Jackson and AIT at the Army School of Music at JEB Little Creek in the first half of 2022. ¶ Fadden currently attends West Chester University of Pennsylvania, where he is studying for a Bachelor of Arts in Political Science with minors in Military Science and Philosophy.In his junior year, having had prior service, he joined the Army ROTC program as an MS3(or 3rd- year cadet).Upon completion of his undergraduate studies in May 2025, he will commission as a 2nd Lieutenant. ¶ Cadet Fadden is one of the three Euphonium players in the unit.During his time in the 78th, he has participated in the Best Warrior Competition, completed Driver's Training courses, and serves as the Unit Voting Assistance Officer. ¶ Outside of the band, Fadden's passions include a deep devotion to the Catholic faith and involvement in local, state, and federal politics in southeast Pennsylvania.",
    img: noPic,
    section: "Brass",
  },
  {
    id: uuidv4(),
    name: "SSG Mikayla Bertelsen ",
  ...
  {
    id: uuidv4(),
    name: "SPC Edward Savoy",
    bio: "SPC Edward Savoy was born and raised in Plymouth Massachusetts where he started playing guitar at the age of 8.  While attending Plymouth South High School SPC Savoy was a dedicated member of the school’s performing arts department, playing in the school’s concert band, marching band, and indoor percussion ensemble.  Upon graduating Plymouth South SPC Savoy had the desire to continue his passion for music and joined the 78th Army Band of Fort Dix New Jersey in March of 2021.  In the 78th SPC Savoy serves as the lead guitarist for the units pop punk MPT ‘9x9’, as well as the lead guitarist for ‘Checkmate’, the units popular music MPT. ¶ SPC Savoy currently resides in Plymouth Massachusetts with his two sisters, mom, step father, and dog.He works as a union laborer for a road construction company; traveling most weeks serving the greater New England area.In his free time he enjoys skateboarding, weightlifting, cooking, hiking, and playing video games.",
    img: noPic,
    section: "Guitar",
  },
  {
    id: uuidv4(),
    name: "SSG Orlando Diazmorales",
