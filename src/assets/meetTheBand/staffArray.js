...
export const staff = [
  ...
  /*   {
      ...
      rank: "1SG",
      name: "David Federico",
      bio: "Originally from Gilbertsville PA, First Sergeant Federico enlisted in the Missouri National Guard Band as a percussionist in 1995. In 1996 he enlisted in active-duty service and graduated from the Navy-Army Element School of Music in 1997. His first duty assignment was the Infantry Band in Ft. Benning Ga. During his assignment, his unit received a unit meritorious award for performing countless ceremonies such as graduations for Basic Training, Infantry Officer Basic and Advance courses, Basic Leader Course, Officer Basic Course, Ranger, and Airborne school. The mission highlight of his assignment was performing for Vice President Gore for his visit to the School of Americas Training Center. During his assignment MSG Federico was also the proud recipient of “Soldier of the Month” for the post and then continued to compete in other advanced competition boards. ¶ MSG Federico attended and graduated from the Primary Leadership Development Course – now referred to the Basic Leader’s course—at Ft. Benning’s NCO Academy. For his achievements, MSG Federico received the Army Achievement Award for high musical performance for numerous high-profile missions and an Army Commendation Medal as a PCS award for his performance as a percussionist, Supply Clerk, and Operations Clerk.  ¶ In 2000 MSG Federico was reassigned to Ft. Lee Army Band in Virginia. During his assignment he was promoted to Sergeant and was charged with the roles of Operations NCOIC, squad leader, and Dixie MPT leader.  During his three-year tour, he provided operations for over 1000 missions. In the aftermath of 9/11, the band was reassigned to its secondary duty of augmenting Military Police force and assigned to providing perimeter security for the base. Additionally, he had the distinct honor to perform for President George W. Bush with the Ft. Lee Jazz Combo for a dining-in, honoring the President’s achievements. There he received an ARCOM as a PCS award for his duties as Percussionist, Dixie MPT leader, squad leader, and Operations NCOIC. ¶ In 2003, MSG Federico was reassigned to the 1st Infantry Division Band in Bamberg, Germany. During his time there the unit was deployed to Iraq in support of Operations Iraqi Freedom II. In 2004 the unit was assigned to Forward Operating Base Danger, the 1st ID Headquarters for the campaign. In addition to providing morale and welfare for troops through musical entertainment, he was tasked with providing perimeter security for the Tactical Operations Center. During the campaign MSG Federico earned the 1st ID combat patch, Global War on Terrorism Expeditionary Medal, and the Global War on Terrorism Service Medal. He was selected to Staff Sergeant and promoted while assigned to Camp Udari, Kuwait. One of the highlights of the tour was performing for the Change of Command from 3rd ID to 1st ID in Tikrit Iraq. For their service the 1st ID band earned a Unit Meritorious medal. ¶ In 2006 MSG Federico transitioned to the Army Reserve and joined the 307th Army Band, which was later restructured into his current assignment, the 78th Army Band. A graduate from the Army School of Music Advance Leader Course and the Senior Leader Course as well as the Master Resiliency Trainer Course in 2012 (University of Pennsylvania), MSG Federico currently serves as the unit’s Operations NCOIC, MPT leader for the rock combo “Checkmate”, squad leader, and Master Resilience Trainer. ¶ Promoted to Sergeant First Class In 2014, performance highlights include performing the National Anthem for multiple Phillies Games, half-time performances for the Philadelphia Eagles, the Philadelphia 4th of July parade, the Washington DC National Memorial Day Parade, and a performance for President Obama at McGuire Airforce Base. ¶ MSG Federico is a graduate of the University of Maryland with a degree in psychology. In his civilian career he is a licensed principal for the Vanguard group, supervising ultra-high net-worth relationship managers. ¶ MSG Federico is married to Jill Walker and has 2 children, Brianna (20) and Joshua (16).",
  ...
  },
  {
    ...
    rank: "SFC",
    name: "Joseph Naples",
    bio: "Senior Musician and Trumpeter/Bugler SFC Joseph Naples, from Long Island, New York became an Army Bandsman in 2011. He earned a Bachelor of Music degree in Music Performance from Portland State University in Portland, Oregon in 2014 and a Master of Science degree in Music Education from Long Island University in Long Island, New York in 2016. ¶ SFC Naples serves within the 78th Army Band as Lead/Secondary Trumpeter/Bugler, and Army Drum Major. He has also served as a Music Educator in public schools since 2016 and enjoys working toward making a difference within his community. ¶ In his free time, SFC Naples enjoys athletics, exercise, writing music, and spending time with his family.",
    section: "Brass",
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    rank: "1SG",
    name: "Paul Harding",
    bio: "First Sergeant Paul A. Harding hails from Clinton, MD.  He enlisted into the District of Columbia Army National Guard (DCARNG) as a Specialist on 26 August 2005 and attended Basic Combat Training at Fort Leonardwood, MO and Advanced Individual Training at Joint Expeditionary Base Little Creek, VA.  After graduation from his Initial Entry Training, he was awarded the military occupational specialty (MOS) of 42R, Musician.  While with the DCARNG, he performed for the inauguration of the 44th President of the United States Barrack Obama. ¶  1SG Harding later transitioned to the Army Reserve and to his current unit of assignment, the 78th Army Band, stationed at Joint Base McGuire-Dix-Lakehurst, NJ on 13 April 2010.  While with the 78th Army Band, he has served in various positions to include, Administration NCO, Supply NCO, Armorer, Physical Security NCO, Assistant Team Leader, Antiterrorism NCO, and currently the Training and Operations NCO as a full-time Active Guard Reserve (AGR) Soldier. ¶ 1SG Harding has attended various military schools: Warrior Leader Course, Combat Lifesaver Course, Basic Combatives Course (Level 1), USAR Unit Administrator Basic Course, Advanced Leader Course, USAR Unit Pay Administrator Course, Antiterrorism Officer Basic Course (Level 2), Army Training Requirements and Resource System (ATRRS) Operator Course, Training Plan Development Course, and Battle Staff Non-Commissioned Officer Course. ¶ 1SG Harding’s awards and decorations include the Army Commendation Medal (1OLC), Army Achievement Medal (1OLC), Army Good Conduct Medal, Army Reserve Component Achievement Medal (3OLC), Armed Forces Reserve Medal (Bronze Hour Glass), Army Superior Unit Award, Non-Commissioned Officer Professional Development Ribbon (3), and is a recipient of the of the German Armed Forces Marksmanship Badge (Schuetzenschnur). ¶ 1SG Harding holds a Bachelors of Music (BM) degree from the University of Maryland, College Park and completed advanced studies in music performance from Towson University, MD. ¶ 1SG Harding is married to Leslynn S. Harding and has two amazing sons, Paul AJ Harding and Christian L. Harding.",
    section: "Command Team",
  },
  {
    id: uuidv4(),
