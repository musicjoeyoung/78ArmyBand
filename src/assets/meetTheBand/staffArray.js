...
export const staff = [
  ...
  },
  {
    ...
    rank: "MSG",
    name: "Paul Harding",
    bio: "Master Sergeant Paul A. Harding hails from Clinton, MD.  He enlisted into the District of Columbia Army National Guard (DCARNG) as a Specialist on 26 August 2005 and attended Basic Combat Training at Fort Leonardwood, MO and Advanced Individual Training at Joint Expeditionary Base Little Creek, VA.  After graduation from his Initial Entry Training, he was awarded the military occupational specialty (MOS) of 42R, Musician.  While with the DCARNG, he performed for the inauguration of the 44th President of the United States Barrack Obama. ¶  MSG Harding later transitioned to the Army Reserve and to his current unit of assignment, the 78th Army Band, stationed at Joint Base McGuire-Dix-Lakehurst, NJ on 13 April 2010.  While with the 78th Army Band, he has served in various positions to include, Administration NCO, Supply NCO, Armorer, Physical Security NCO, Assistant Team Leader, Antiterrorism NCO, and currently the Training and Operations NCO as a full-time Active Guard Reserve (AGR) Soldier. ¶ MSG Harding has attended various military schools: Warrior Leader Course, Combat Lifesaver Course, Basic Combatives Course (Level 1), USAR Unit Administrator Basic Course, Advanced Leader Course, USAR Unit Pay Administrator Course, Antiterrorism Officer Basic Course (Level 2), Army Training Requirements and Resource System (ATRRS) Operator Course, Training Plan Development Course, and Battle Staff Non-Commissioned Officer Course. ¶ MSG Harding’s awards and decorations include the Army Commendation Medal (1OLC), Army Achievement Medal (1OLC), Army Good Conduct Medal, Army Reserve Component Achievement Medal (3OLC), Armed Forces Reserve Medal (Bronze Hour Glass), Army Superior Unit Award, Non-Commissioned Officer Professional Development Ribbon (3), and is a recipient of the of the German Armed Forces Marksmanship Badge (Schuetzenschnur). ¶ MSG Harding holds a Bachelors of Music (BM) degree from the University of Maryland, College Park and completed advanced studies in music performance from Towson University, MD. ¶ MSG Harding is married to Leslynn S. Harding and has two amazing sons, Paul AJ Harding and Christian L. Harding.",
    section: "Woodwinds",
  },
  {
    id: uuidv4(),
