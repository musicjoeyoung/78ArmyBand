...
export class Profile extends Component {
    ...
    this.state = {
      staff: [
        ...
        },
        {
          ...
          bio: "This is the bio for SFC Greenway",
          img: band78,
          section: "Brass",
        },
        {
  ...
  render() {
    const CommandTeam = this.state.staff
      .filter(function (staff) {
        return staff.section === "Command Team";
      })
      .map(function (staff) {
        return (
          <div>
    ...
    const Brass = this.state.staff
      .filter(function (staff) {
        return staff.section === "Brass";
      })
      .map(function (staff) {
        return (
          <div>
