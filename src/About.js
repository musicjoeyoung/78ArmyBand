...
import newImg3 from "./images/armyband1.jpg";
import newImg4 from "./images/armyband2.jpeg"; */
...
function changeBioGroup1() {
  document.getElementById("bioImg1").src = newImg;
  document.getElementById("bioText1").innerText = bio1;
  document.getElementById("bioImg2").src = newImg2;
  document.getElementById("bioText2").innerText = bio2;
}

function changeBioGroup2() {
  document.getElementById("bioImg1").src = newImg3;
  document.getElementById("bioText1").innerText = bio3;
  document.getElementById("bioImg2").src = newImg4;
  document.getElementById("bioText2").innerText = bio4;
} */

function changeToBrass() {
  document.getElementById("section").src = <Brass />;
}
    ...
    return (
      <div>
        ...
        <div className="meetTheBand">
          <div className="dropdownDiv">
            <div className="dropdown">
              ...
              <div className="navbar">
                <li id="navbarLinks" /* onClick={changeBioGroup1} */>
                  Command Team
                </li>
                <li id="navbarLinks" onClick={changeToBrass}>
                  Brass
                </li>
              </div>
            </div>
          ...
          <div id="section">
            {/*  <h3>Command Team</h3>
            <img id="bioImg1" src={bioImg} alt="" />
            <p id="bioText1" src={bio1} />
            <img id="bioImg2" src={bioImg} alt="" />
            <p id="bioText2" src={bio1} />
            <img id="bioImg3" src={bioImg} alt="" />
            <p id="bioText3" src={bio1} />
            <img id="bioImg4" src={bioImg} alt="" />
            <p id="bioText4" src={bio1} /> */}
          </div>
        </div>
        <Footer />
      </div>
